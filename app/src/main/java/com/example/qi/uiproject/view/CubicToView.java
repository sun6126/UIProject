...
public class CubicToView extends View {
    ...
    public CubicToView(Context context) {
        super(context);
        init();
    }

    public CubicToView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();

    }

    public CubicToView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
